...
HairVertexVID AddAngularForcesVS(HairVertex input, uint vertexID
                                 : SV_VertexID)
{
...
HairVertex addForcesAndIntegrateVS(HairVertexPair particlePair, uint vertexID
                                   : SV_VertexID)
{
    ...
    */
    ...
    outputPos.Position.xyz = particlePair.position.xyz + velocity.xyz + force.xyz * TimeStep * TimeStep;
...
ConstraintsHairVertex SatisfySpringConstraintsVS(HairVertexLength input, uint vertexID
                                                 : SV_VertexID)
{
...
ConstraintsAngularHairVertex SatisfyAngularSpringConstraintsVS(HairVertexLengthStiffness input, uint vertexID
                                                               : SV_VertexID)
{
...
void restoreToDefaultPositionsVS(inout HairVertex input, uint vertexID
                                 : SV_VertexID)
{
    float4 originalPosition = g_OriginalMasterStrand.Load(vertexID);
...
[MaxVertexCount(2)] void AddAngularForcesGS(line HairVertexVID vertex[2], inout PointStream<HairVertex> stream)
{
    ...
    [MaxVertexCount(2)] void SatisfySpringConstraintsGS(line ConstraintsHairVertex vertex[2], inout PointStream<HairVertex> stream)
{
    HairVertex vertex0, vertex1;
    vertex0.Position = vertex[0].Position;
    vertex1.Position = vertex[1].Position;
...
[MaxVertexCount(4)] void SatisfyAngularSpringConstraintsGS(lineadj ConstraintsAngularHairVertex vertex[4], inout PointStream<HairVertex> stream)
{
...
coordinateFrame4 UpdateCoordinateFrameVS(coordinateFrame4 cf, uint vertexID
                                         : SV_VertexID)
{
...
coordinateFrame4 PropagateCoordinateFrameVS(coordinateFrame4 cf, uint vertexID
                                            : SV_VertexID)
{
...
coordinateFrameAndID RenderCoordinateFrameVS(coordinateFrame4 cf, uint vertexID
                                             : SV_VertexID)
{
...
coordinateFrameAndID RenderCoordinateFrameVSUnTess(uint vertexID
                                                   : SV_VertexID)
{
...
coordinateFrameAndID RenderCoordinateFrameVSUnTessSB(uint vertexID
                                                     : SV_VertexID)
{
...
[MaxVertexCount(6)] void RenderCoordinateFrameGSUnTessellated(point coordinateFrameAndID cf[1], inout LineStream<coordinateFrameRender> stream)
{
    ...
    [MaxVertexCount(6)] void RenderCoordinateFrameGSUnTessellatedSB(point coordinateFrameAndID cf[1], inout LineStream<coordinateFrameRender> stream)
{
    // load the vertex point
...
[MaxVertexCount(6)] void RenderCoordinateFrameGSTessellated(point coordinateFrameAndID cf[1], inout LineStream<coordinateFrameRender> stream)
{
    // load the vertex point
...
coordinateFrame4 TessellateVSBSplineCFs(HairAdjacencyVertex input, uint vertexID
                                        : SV_VertexID)
{
    coordinateFrame4 output;
...
// create coordinate frames for the tessellated hair
coordinateFrame4 TessellateVSBSplineSBCFs(HairAdjacencyVertex input, uint vertexID
                                          : SV_VertexID)
{
    coordinateFrame4 output;
                                 ...
                                 inout float3 originalMasterStrandRoots_output, inout float lengthToRoot_output, inout float lengthsw_output)
{
    ...
    float2 BaryCentricTexcoords = coords.x * rootTexcoords[0].xy + coords.y * rootTexcoords[1].xy + coords.z * rootTexcoords[2].xy;
                                  ...
                                  inout float barycentricWeight_output, inout float clumpWeight_output, inout float2 texcoords_output)
{
    ...
    float BarycentricTotalLength = coords.x * totalLengths[0] + coords.y * totalLengths[1] + coords.z * totalLengths[2];
...
HairVertex2 InterpolateVSBarycentricTotalCore(uint InstanceID, uint vertexID)
{
    ...
    float3 BarycentricTangent = coords.x * masterVertexTangents[0].xyz + coords.y * masterVertexTangents[1].xyz + coords.z * masterVertexTangents[2].xyz;
...
HairCollisionVertex InterpolateVSBarycentricCollisions_withInput(HS_CONTROL_POINTCOLLISIONS_OUTPUT_INTERP_B vertex0, HS_CONTROL_POINTCOLLISIONS_OUTPUT_INTERP_B vertex1, HS_CONTROL_POINTCOLLISIONS_OUTPUT_INTERP_B vertex2, float4 lengths, float totalLengths[3], float2 rootTexcoords0, float2 rootTexcoords1, float2 rootTexcoords2, uint vertexID, uint InstanceID)
{
    ...
    // barycentric position---------------------------------------------------
    float3 BarycenticPosition = coords.x * vertex0.tessellatedPosition.xyz + coords.y * vertex1.tessellatedPosition.xyz + coords.z * vertex2.tessellatedPosition.xyz;
...
HairVertex2 InterpolateVSMultiStrand(uint InstanceID
                                     : SV_InstanceID, uint vertexID
                                     : SV_VertexID)
{
...
InterpolatedSOBarycentricVertex InterpolateVSMultiStrand_SO(uint vertexID
                                                            : SV_VertexID)
{
    HairVertex2 hairvert = InterpolateVSBarycentricTotalCore(vertexID / g_TessellatedMasterStrandLengthMax, vertexID % g_TessellatedMasterStrandLengthMax);
...
HairVertex2 InterpolateVSMultiStrand_LOAD(uint index
                                          : SV_VertexID)
{
    HairVertex2 output = (HairVertex2)0;
...
HairVertexPWI InterpolateVSMultiStrandDepthShadows_LOAD(uint index
                                                        : SV_VertexID)
{
...
HairCollisionVertex InterpolateVSMultiStrandCollisions(uint InstanceID
                                                       : SV_InstanceID, uint vertexID
                                                       : SV_VertexID)
{
    HairCollisionVertex output = (HairCollisionVertex)0;
...
BARY_HS_CONSTANT_DATA_OUTPUT InterpolateConstHSMultiStrand(uint iWisp
                                                           : SV_PrimitiveID)
{
...
[domain("isoline")]
    ...
    [patchconstantfunc("InterpolateConstHSMultiStrand")] void
    InterpolateHSMultiStrand(InputPatch<DUMMY, 1> inputPatch) {
    }
// each hull shader processes c-strands belonging to the same master strand
BARYDEPTH_HS_CONSTANT_DATA_OUTPUT InterpolateConstHSMultiStrandDepth(uint iWisp
                                                                     : SV_PrimitiveID)
{
...
[domain("isoline")]
    ...
    [outputtopology("line")]
    [outputcontrolpoints(1)]
    [patchconstantfunc("InterpolateConstHSMultiStrandDepth")] void
    InterpolateHSMultiStrandDepth(InputPatch<DUMMY, 1> inputPatch) {
    }

// each hull shader processes c-strands belonging to the same master strand
BARYCOLLISIONS_HS_CONSTANT_DATA_OUTPUT InterpolateConstHSMultiStrandCollisions(uint iWisp
                                                                               : SV_PrimitiveID)
{
...
[domain("isoline")]
    ...
    [outputtopology("line")]
    [outputcontrolpoints(1)]
    [patchconstantfunc("InterpolateConstHSMultiStrandCollisions")] void
    InterpolateHSMultiStrandCollisions(InputPatch<DUMMY, 1> inputPatch) {
    }

// each hull shader processes c-strands belonging to the same master strand
HS_CONSTANT_DATA_OUTPUT InterpolateConstHSSingleStrand(uint iPatch
                                                       : SV_PrimitiveID)
{
...
[domain("isoline")]
    ...
    [outputtopology("line")]
    [outputcontrolpoints(1)]
    [patchconstantfunc("InterpolateConstHSSingleStrand")] void
    InterpolateHSSingleStrand(InputPatch<DUMMY, 1> inputPatch) {
    }
        [domain("isoline")] HairVertex2 InterpolateDSMultiStrand(OutputPatch<DUMMY, 1> inputPatch, BARY_HS_CONSTANT_DATA_OUTPUT input, float2 uv
                                                                 : SV_DomainLocation, uint iWispID
                                                                 : SV_PrimitiveID)
{
    ...
    float2 BaryCentricTexcoords = coords.x * input.rootTexcoords[0].xy + coords.y * input.rootTexcoords[1].xy + coords.z * input.rootTexcoords[2].xy;
    ...
    float BarycentricTotalLength = coords.x * input.totalLengths[0] + coords.y * input.totalLengths[1] + coords.z * input.totalLengths[2];
...
[domain("isoline")] HairVertexPWI InterpolateDSMultiStrandDepth(OutputPatch<DUMMY, 1> inputPatch, BARYDEPTH_HS_CONSTANT_DATA_OUTPUT input, float2 uv
                                                                : SV_DomainLocation, uint iWispID
                                                                : SV_PrimitiveID)
{
    // how many hairs did we render before this master strand
    ...
    [domain("isoline")] HairCollisionVertexWithGS InterpolateDSMultiStrandCollisionsWithGS(OutputPatch<DUMMY, 1> inputPatch, BARYCOLLISIONS_HS_CONSTANT_DATA_OUTPUT input, float2 uv
                                                                                           : SV_DomainLocation, uint iWispID
                                                                                           : SV_PrimitiveID)
{
    HairCollisionVertex output = (HairCollisionVertex)0;
...
[domain("isoline")] HairVertex2 InterpolateDSSingleStrand_NORMAL(OutputPatch<DUMMY, 1> inputPatch, HS_CONSTANT_DATA_OUTPUT input, float2 uv
                                                                 : SV_DomainLocation, uint MasterStrandNumber
                                                                 : SV_PrimitiveID)
{
    HairVertex2 output;
    ...
    [domain("isoline")] HairVertexPWI InterpolateDSSingleStrand_DEPTH(OutputPatch<DUMMY, 1> inputPatch, HS_CONSTANT_DATA_OUTPUT input, float2 uv
                                                                      : SV_DomainLocation, uint MasterStrandNumber
                                                                      : SV_PrimitiveID)
{
    // how many hairs did we render before this master strand
...
[maxvertexcount(1)] void InterpolateGSClump_SO(point InterpolatedSOBarycentricVertex vertex[1],
                                               inout PointStream<InterpolatedSOBarycentricVertex> OutputStream)
{
    OutputStream.Append(vertex[0]);
} HairVertex2 InterpolateVSSingleStrand(uint InstanceID
                                        : SV_InstanceID, uint vertexID
                                        : SV_VertexID)
{
...
InterpolatedSOBarycentricVertex InterpolateVSSingleStrand_SO(uint vertexID
                                                             : SV_VertexID)
{
    HairVertex2 hairvert = InterpolateVSClumpTotalCore(vertexID / g_TessellatedMasterStrandLengthMax, vertexID % g_TessellatedMasterStrandLengthMax);
...
HairVertex2 InterpolateVSSingleStrand_LOAD(uint index
                                           : SV_VertexID)
{
    HairVertex2 output = (HairVertex2)0;
...
HairVertexPWI InterpolateVSSingleStrandDepthShadows_LOAD(uint index
                                                         : SV_VertexID)
{
    HairVertexPWI output;
    float4 PositionAndWidth = g_InterpolatedPositionAndWidthClump.Load(index);
...
HairVertex2Grid InterpolateVS2Grid(uint InstanceID
                                   : SV_InstanceID, uint vertexID
                                   : SV_VertexID)
{
    ...
    float3 position = coords.x * masterVertexPosition[0].xyz + coords.y * masterVertexPosition[1].xyz + coords.z * masterVertexPosition[2].xyz;
...
[MaxVertexCount(1)] void TessellateGSBSpline(point HairAdjacencyVertex input[1], inout PointStream<HairVertexTangent> inStream)
{
    ...
    [MaxVertexCount(1)] void TessellateGSBSplineSB(point HairAdjacencyVertex input[1], inout PointStream<HairVertexTangent> inStream)
{
    HairVertexTangent output;
...
[MaxVertexCount(8)] void InterpolateGS2Grid(line HairVertex2Grid vertex[2], inout TriangleStream<HairPointGrid> stream)
{
    if (vertex[0].ID < 0 || vertex[1].ID < 0)
        return;
...
[maxvertexcount(3)] void GS_ARRAY(triangle VS_OUTPUT_FLUIDSIM In[3], inout TriangleStream<GS_OUTPUT_FLUIDSIM> triStream)
{
