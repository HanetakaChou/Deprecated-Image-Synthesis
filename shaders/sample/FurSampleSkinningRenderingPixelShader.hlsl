...
//
//////////////////////////////////////////////////////////////////////////////
// SAMPLE SHADER FOR FurSampleSkinning.cpp
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
GFSDK_HAIR_DECLARE_SHADER_RESOURCES(t0, t1, t2); // declare resources to retrieve shader attributes
...
#define NUM_LIGHTS 4
	...
	[unroll] for (int i = 0; i < NUM_LIGHTS; i++)
	{
		...
		float3 Ldir = 1.0f * normalize(lightDir[i]); // light direction defined from shaded point toward the light
